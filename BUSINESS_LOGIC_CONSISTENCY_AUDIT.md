...
> - **M3** — глоссарий существенно расширен: с ~10 до **61 термина** (7 секций: домены, сущности, роли/принципалы, статусы/стейт-машины, концепции данных, JSONB-схемы, внешнее/юридическое), EN+RU паритет.
> - **D7** — тождество `VET` (`role_in_org`) ≡ `VETERINARIAN` (`users.role`) зафиксировано в глоссарии.
>
> **Итог: все D1–D7 и M1–M4 устранены (P0+P1+P2 закрыты).** Спека готова к реализации; источники истины (схема/стейт-машины/контракты) согласованы, термины глоссированы.
