...
- Оба животных должны быть:
 ...
 - Принадлежать разным пользователям (самосопоставление не допускается)
 - Иметь объявления типа MATING или STUD_SERVICE (или пользователь указал интерес к разведению)
...
- **Ветеринарный статус**: Бонус для обоих животных, отрицательных на ключевые заболевания (ТБ, Brucellosis,约翰ес и т.д.)
...
- **Совместимость по размеру/рамке**: Бонус за適当ный размер соответствия (особенно важно для лошадей/собак)
...
- **Триггер**: Сопоставление может быть инициировано:
 - Пользователем, просматривающим объявление MATING/STUD_SERVICE и запрашивающим "Найти похожее" или "Найти сопоставления"
...
- Хотя бы одно из целевого или кандидатного животного должно иметь активное объявление MATING/STUD_SERVICE или флаг намерения пользователя на разведение
...
- **Предположение**: Исходные веса сопоставления основаны на экспертных знаниях и могут быть уточнены со временем с учетом обратной связи пользователей.
- **Предположение**: Большинство пользователей будут инициировать сопоставление от животного, которым они владеют (а не от анонимного поиска).
- **Открытый вопрос**: Следует ли разрешить межпородное сопоставление одного вида на MVP с явным согласием? (Решено: Нет, зарезервировать для Фазы 2+ чтобы избежать сложности и потенциального злоупотребления.)
- **Предположение**: Пользователи понимают, что сопоставление является инструментом предложения; окончательные решения о разведении включают ветеринарную консультацию и прямые переговоры.
- **Предположение**: Система не гарантирует плодовитость или беременность; сопоставление оценивает только на основе доступных данных.
- **Предположение**: Генетические данные, используемые, ограничены тем, что владельцы добровольно предоставляют (тесты, родословные).
