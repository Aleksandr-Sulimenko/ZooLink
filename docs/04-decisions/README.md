...
- [ADR-0022: Multi-role user — `user_roles` junction + JIT self-claim seam (form-now)](0022-multi-role-user.md) *(Proposed — Wave-D D6; junction with `users.role` primary, dormant in MVP; regulated self-claim gated by ADR-0016 tier; OD-A/OD-B open)*
