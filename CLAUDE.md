...
> Состояние БД: **31 таблица**, миграции `0001`–`0011` идемпотентны (`0011` = reference-seed), ~два десятка инвариантов enforced. Reference + reasons/templates сидятся `npm run seed` (идемпотентно).
