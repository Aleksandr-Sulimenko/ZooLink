...
- [ ] **Update API DTOs / guards** (if any) to handle new roles.
...
- [ ] **Optionally**, keep single `healthStatus` field as logical view and note that implementation splits for indexing.
...
- [ ] **Update API contracts** if needed (already include).
